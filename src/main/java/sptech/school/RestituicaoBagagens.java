...
public class RestituicaoBagagens {
    ...
    public RestituicaoBagagens(Integer processoRestituicaoBagagens, Integer facilidadeIdentificacaoEsteira, Integer tempoRestituicao, Integer integridadeBagagem, Integer atendimentoCiaAerea) {
